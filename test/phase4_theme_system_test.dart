...
void main() {
  ...
  group('Phase 4: Theme & Visual System Unit Tests', () {
    ...
    test('1. ThemeModeNotifier initializes synchronously and supports light/dark/system persistence', () async {
    ...
    test('2. AppTheme.lightTheme and AppTheme.darkTheme register AppColorsExtension', () {
    ...
    testWidgets('3. BuildContext.appColors extension resolves correctly in widget tree', (tester) async {
