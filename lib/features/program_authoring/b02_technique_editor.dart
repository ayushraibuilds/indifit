          ...
          Wrap(
            ...
            children: [
              Semantics(
                ...
                child: DropdownButton<B02PausedRepPosition>(
                  value: _value.pausedRepPosition,
                  items: [
                    for (final position in B02PausedRepPosition.values)
                      DropdownMenuItem(
                        value: position,
                        child: Text(position.dbValue),
                      ),
                  ],
                  onChanged: (position) {
                    if (position != null) {
          ...
          Wrap(
            ...
            children: [
              Semantics(
                ...
                child: DropdownButton<B02AssistanceMode>(
                  value: _value.assistanceMode,
                  items: [
                    for (final mode in B02AssistanceMode.values)
                      DropdownMenuItem(value: mode, child: Text(mode.dbValue)),
                  ],
                  onChanged: (mode) {
                    if (mode != null) {
      ...
      child: ExpansionTile(
        ...
        children: [
          ...
          SwitchListTile.adaptive(
            ...
            subtitle: const Text('Record decreasing external loads by segment'),
          ...
          SwitchListTile.adaptive(
            ...
            subtitle: const Text('Record positive rest before later clusters'),
