...
class _WeeklyReportScreenState extends ConsumerState<WeeklyReportScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Weekly Digest & Coaching'),
      ),
      body: _buildBody(),
    );
  }
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                report.summary,
                textAlign: TextAlign.center,
                style: B05Typography.caption(context).copyWith(fontSize: 13, height: 1.5),
              ),
          ...
          if (report.isFallback) ...[
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: colors.warning.indicator.withValues(alpha: 0.4)),
              ),
              child: Row(
                children: [
                  Icon(
                ...
                Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        report.headline,
                        style: B05Typography.title(context).copyWith(fontSize: 17),
                      ),
                    ),
                  ],
                ),
        ...
        ClipRRect(
          ...
          child: LinearProgressIndicator(
            ...
            valueColor: AlwaysStoppedAnimation<Color>(
              score != null ? _getAdherenceColor(score) : colors.border,
            ),
            minHeight: 4,
          ),
        ),
  ...
  Color _getAdherenceColor(double score) {
    if (score >= 0.8) return context.b05Colors.success.indicator;
    if (score >= 0.5) return context.b05Colors.warning.indicator;
    return context.b05Colors.danger.indicator;
  }
