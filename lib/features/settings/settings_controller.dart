          ...
          await db
              ...
              .insert(
                FoodItemsCompanion.insert(
                  ...
                  fiberG: Value(
                    item['fiber_g'] != null
                        ? (item['fiber_g'] as num).toDouble()
                        : null,
                  ),
                  servingSize: item['serving_size'] != null
                      ? (item['serving_size'] as num).toDouble()
                      : 100.0,
          ...
          await db
              ...
              .insert(
                WorkoutSessionsCompanion.insert(
                  id: Value(item['id']),
                  name:
                      item['name'] ?? item['routine_name'] ?? 'Workout Session',
                  ...
                  durationSeconds: item['duration_seconds'] != null
                      ...
                      : 0,
                  estimatedCalories: item['estimated_calories'] != null
                      ? (item['estimated_calories'] as num).toInt()
                      : 0,
                  uuid: Value(item['uuid'] ?? const Uuid().v4()),
          ...
          await db
              ...
              .insert(
                WorkoutSetsCompanion.insert(
                  ...
                  rpe: Value(
                    item['rpe'] != null ? (item['rpe'] as num).toInt() : null,
                  ),
          ...
          await db
              ...
              .insert(
                BodyMeasurementsCompanion.insert(
                  ...
                  waist: Value(
                    item['waist'] != null
                        ? (item['waist'] as num).toDouble()
                        : null,
                  ),
                  chest: Value(
                    item['chest'] != null
                        ? (item['chest'] as num).toDouble()
                        : null,
                  ),
                  arms: Value(
                    item['arms'] != null
                        ? (item['arms'] as num).toDouble()
                        : null,
                  ),
