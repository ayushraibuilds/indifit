class HouseholdMeasure {
  ...
  static const List<HouseholdMeasure> allMeasures = [
    ...
    HouseholdMeasure(
      key: 'katori',
      label: 'Standard Katori (~150g)',
      labelHindi: 'कटोरी (~150 ग्राम)',
      gramEquivalent: 150.0,
    ),
    HouseholdMeasure(
      key: 'katori_full',
      label: 'Full Katori (~200g)',
      labelHindi: 'बड़ी कटोरी (~200 ग्राम)',
      gramEquivalent: 200.0,
    ),
    HouseholdMeasure(
      key: 'tbsp_ghee',
      label: 'Tbsp Ghee / Oil (~15g)',
      labelHindi: 'चम्मच घी/तेल (~15 ग्राम)',
      gramEquivalent: 15.0,
    ),
    HouseholdMeasure(
      key: 'small_roti',
      label: 'Small Roti (~30g)',
      labelHindi: 'छोटी रोटी (~30 ग्राम)',
      gramEquivalent: 30.0,
    ),
    HouseholdMeasure(
      key: 'medium_roti',
      label: 'Medium Roti (~45g)',
      labelHindi: 'मध्यम रोटी (~45 ग्राम)',
      gramEquivalent: 45.0,
    ),
    HouseholdMeasure(
      key: 'large_roti',
      label: 'Large Roti (~60g)',
      labelHindi: 'बड़ी रोटी (~60 ग्राम)',
      gramEquivalent: 60.0,
    ),
    HouseholdMeasure(
      key: 'cup',
      label: 'Measuring Cup (~240g)',
      labelHindi: 'कप (~240 ग्राम)',
      gramEquivalent: 240.0,
    ),
    HouseholdMeasure(
      key: 'thali',
      label: 'Full Thali Plate',
      labelHindi: 'थाली',
      gramEquivalent: 400.0,
    ),
  ];
