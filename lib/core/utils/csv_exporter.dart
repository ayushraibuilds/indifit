...
class CsvExporter {
  ...
  static String exportFoodLogsToCsv(List<FoodLog> logs) {
    ...
    buffer.writeln(
      'ID,Date,Meal Type,Food Name,Calories (kcal),Protein (g),Carbs (g),Fat (g),Serving Size,Serving Unit',
    );
  ...
  static String exportWorkoutSessionsToCsv(
  ...
  static String exportBodyMeasurementsToCsv(
