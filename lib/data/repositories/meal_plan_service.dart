...
class MealPlanService {
  ...
  GeneratedMealPlanResult _generateOfflineFallback(
    int calorieGoal,
    ...
    final List<Map<String, dynamic>> days = [
      {
        'day': 'Monday',
        'breakfast':
            'Oats Upma (1 bowl) with almonds (10 pcs) - 350 kcal | P: 12g',
        'lunch':
            'Paneer Bhurji (150g) with 2 Chapatis & Curd - 550 kcal | P: 28g',
        'dinner':
            'Yellow Dal Tadka (1 bowl) with Mixed Veg & 2 Chapatis - 480 kcal | P: 18g',
        'snacks': 'Roasted Chana (50g) & Green Tea - 180 kcal | P: 9g',
      },
      {
        'day': 'Tuesday',
        'breakfast':
            'Paneer Stuffed Paratha (1 pc) with curd - 380 kcal | P: 14g',
        'lunch':
            'Soya Chunks Curry (1 bowl) with Jeera Rice - 520 kcal | P: 26g',
      ...
      },
      {
        'day': 'Wednesday',
        'breakfast':
            'Besan Cheela (2 pcs) with mint chutney - 320 kcal | P: 12g',
        'lunch':
            'Chickpea (Chole) Salad with cucumber & tomatoes - 480 kcal | P: 18g',
        'dinner':
            'Tofu Stir-fry (150g) with brown rice (1 cup) - 510 kcal | P: 22g',
      ...
      },
      {
        ...
        'lunch':
            'Dal Makhani (1 bowl) with Jeera Rice & Veg Salad - 540 kcal | P: 16g',
        'dinner':
            'Paneer Tikka (150g) with Grilled Bell Peppers - 460 kcal | P: 24g',
      ...
      },
      {
        ...
        'dinner':
            'Black Eyed Peas (Lobia) Curry with brown rice - 490 kcal | P: 18g',
        'snacks': 'Boiled Peanut Salad (50g) - 200 kcal | P: 8g',
      },
      {
        'day': 'Saturday',
        'breakfast':
            'Oats Porridge with 1 scoop Whey Protein - 360 kcal | P: 30g',
      ...
      },
      {
        ...
        'dinner':
            'Paneer Bhurji (150g) with 2 multigrain rotis - 530 kcal | P: 28g',
    ...
    return GeneratedMealPlanResult(
      ...
      isFallback: true,
      fallbackReason:
          'Local offline plan generated for $calorieGoal kcal ($dietPreference).',
    );
  }
}
