...
class NutritionRecipeSource {
  ...
  final String? copiedFromVersionId;
  ...
  NutritionRecipeSource copyWith({
    ...
    String? servingDefinitionSource,
    String? note,
  }) => NutritionRecipeSource(
    kind: kind ?? this.kind,
    parentVersionId: parentVersionId ?? this.parentVersionId,
    copiedFromVersionId: copiedFromVersionId ?? this.copiedFromVersionId,
    ...
    servingDefinitionSource:
        servingDefinitionSource ?? this.servingDefinitionSource,
    note: note ?? this.note,
  );
  ...
  String encode() => jsonEncode({
    ...
    if (copiedFromVersionId != null)
      'copied_from_version_id': copiedFromVersionId,
    ...
    if (servingDefinitionSource != null)
      'serving_definition_source': servingDefinitionSource,
  ...
  factory NutritionRecipeSource.decode(String raw) {
    try {
      ...
      final copiedFrom = map['copied_from_version_id'];
      ...
      return NutritionRecipeSource(
        ...
        copiedFromVersionId: copiedFrom as String?,
        ...
        servingDefinitionSource: servingSource as String?,
        note: note as String?,
      );
...
class NutritionRecipeRepository {
  ...
  Future<NutritionRecipeDraftModel> createDraft({
    ...
    if (source.parentVersionId != null) {
      throw const NutritionRecipeValidationError(
        ...
        'An initial recipe version cannot reference an in-recipe parent.',
      );
    }
    ...
    return _db.transaction(() async {
      ...
      final serving = current.servingQuantity == null
          ...
          : NutritionRecipeServingDefinition(
              ...
              source: currentSource.servingDefinitionSource,
            );
  ...
  Future<NutritionRecipeDraftModel> duplicatePublishedVersion({
    ...
    final source = NutritionRecipeSource(
      ...
      externalReference: currentSource.externalReference,
      note: 'duplicated_from_recipe:${sourceRecipe.id}',
    );
  ...
  Future<NutritionRecipeDraftModel> updateDraft({
    ...
    return _db.transaction(() async {
      ...
      final nextSource = source.copyWith(
        ...
        servingDefinitionSource: nextServing?.source,
      );
      _validateVersionInputs(
  ...
  Future<void> _insertVersion({
    ...
    final storedSource = servingDefinition == null
        ...
        : source.copyWith(
            ...
            servingDefinitionSource: servingDefinition.source,
          );
    await _db
