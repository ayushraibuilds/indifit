...
| *Status:* | | **In Progress** — Executing asset acquisition, wiring interactive Start/Peak pose toggle and technique disclosure in `ExerciseDetailsSheet`, and applying DPR `cacheWidth` thumbnail limits in `ExerciseLibraryScreen`. | | |
