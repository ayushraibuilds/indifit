...
Manifest SHA-256: `57c317256e1d58e69d5d62c71eaf74dc143f6a63f516b388c6a7c361f009b629`
...
ID and source key. Deprecated identities remain resolvable and retain their
IDs.
...
v1 fixture. The explicit ambiguous and unresolved records remain visible for
future Sol/food-catalogue review; they must not be resolved by fuzzy matching or
by current nutrient values.

## Validation and change review

Manifest loading validates the complete document before exposing it. It rejects
duplicate IDs/machine IDs, duplicate canonical normalized names, alias
collisions or orphan targets, variant cycles and unknown parents, unsupported
versions/normalization contracts, unknown provenance/review values, duplicate
legacy keys, contradictory unresolved mappings, provider identity gaps, and
malformed fixture entries. Reordering entries does not alter source-key to ID
relationships.
