...
| `nutrition_vessel_calibrations` | User vessel volume/mass calibration | `id` | `user_id`, `label`, `measure_id`, `volume_ml`, `lower`, `upper`, `method`, `food_id`, `preparation_id`, `confidence` | measure; optional food/preparation | user/label; user/food |
