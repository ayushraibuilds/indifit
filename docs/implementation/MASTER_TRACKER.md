...
| B03 — Nutrition Foundation and Food Context | Chartered | GPT Luna repository audit | None |
...
`batch/b02-workout-execution`. Do not merge B02 into `main` or `develop` until
the final Sol gate passes. B03 planning is recorded on
`batch/b03-nutrition-foundation`; do not create B03 implementation branches
until B02 has passed that gate and has been merged into the accepted base.
